...
public class UserCredentialsEnterValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        if (!errors.hasErrors()) {
            ...
            } else if (userService.findByLoginAndPassword(enterForm.getLogin(), enterForm.getPassword()).isDisabled()) {
                errors.rejectValue("login", "login.user-is-disaled", "Sorry you're disconnected");
            }
        }
    }
}
